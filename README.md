...
```
MailHunter Copyright (C) 2021 Hassan Saad

This file is part of MailHunter tool.

MailHunter is a free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Foundation, either version 3 of the License, or
(at your option) any later version.

MailHunter is distributed in the hope that it will be useful,
